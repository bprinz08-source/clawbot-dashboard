        ...
        <div className="rounded-lg border border-neutral-200 bg-white p-4 shadow-sm dark:border-neutral-800 dark:bg-neutral-950">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <div className="space-y-1">
              ...
              <p className="text-sm text-neutral-600 dark:text-neutral-400">
                Open the read-only staging inspector for intake runs and staged items.
              </p>
            </div>

            <Link
              href="/admin/intake"
              className="inline-flex items-center justify-center rounded-md border border-neutral-300 px-3 py-2 text-sm font-medium text-neutral-900 transition hover:bg-neutral-100 dark:border-neutral-700 dark:text-neutral-100 dark:hover:bg-neutral-900"
            >
              Open Intake Inspector
            </Link>
          </div>
        </div>
      </section>
